...
func And[A, B any](dst A, src B) and[A, B] {
	return and[A, B]{args: xyz.Pair[A, B]{First: dst, Second: src}}
}

func Or[A, B any](dst A, src B) or[A, B] {
	return or[A, B]{args: xyz.Pair[A, B]{First: dst, Second: src}}
}

func Xor[A, B any](dst A, src B) xor[A, B] {
	return xor[A, B]{args: xyz.Pair[A, B]{First: dst, Second: src}}
}
