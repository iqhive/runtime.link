...
func (c *types) LookupKind(name string) reflect.Kind {
	return (*value)(reflect.ValueOf(c).Elem().FieldByName(name).Addr().UnsafePointer()).kind
}

func (c *types) LookupSize(name string) uintptr {
	return (*value)(reflect.ValueOf(c).Elem().FieldByName(name).Addr().UnsafePointer()).size
}

func (c *types) LookupMemoryAlignment(name string) int {
	return (*value)(reflect.ValueOf(c).Elem().FieldByName(name).Addr().UnsafePointer()).align_memory
}

func (c *types) LookupStructAlignment(name string) int {
	return (*value)(reflect.ValueOf(c).Elem().FieldByName(name).Addr().UnsafePointer()).align_struct
}
