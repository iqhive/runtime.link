...
// This file is a copy/paste of the Go 1.27 standard library UUID
// implementation, with the single addition of the //go:build !go1.27 tag.
//
...
// faithful to upstream (aside from the tag) means the behavior on old
// toolchains is identical to the standard library, and it lets CI prove
// parity by running the same test vectors against both backends.
//
// The Go Authors' copyright and BSD license are retained verbatim below, as
// required by the license. Do not rewrite or "improve" this file; if upstream
